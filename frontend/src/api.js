...
export const api = {
  ...
  createTimeOffRequest: (data) => request('/time-requests', { method: 'POST', body: JSON.stringify(data) }),
  createContract: (data) => request('/contracts', { method: 'POST', body: JSON.stringify(data) }),
  createPayrun: (data) => request('/payruns', { method: 'POST', body: JSON.stringify(data) }),
  computePayrun: (id) => request(`/payruns/${id}/compute`, { method: 'POST' }),
  validatePayrun: (id) => request(`/payruns/${id}/validate`, { method: 'POST' }),
  payPayrun: (id) => request(`/payruns/${id}/pay`, { method: 'POST' }),
  sendPayrun: (id) => request(`/payruns/${id}/send-payslips`, { method: 'POST' }),
